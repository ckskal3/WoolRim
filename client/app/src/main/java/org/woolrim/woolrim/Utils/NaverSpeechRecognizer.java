...
public class NaverSpeechRecognizer implements SpeechRecognitionListener {

    private final static String TAG = NaverSpeechRecognizer.class.getSimpleName();
    private Handler mHandler;
    private SpeechRecognizer mRecognizer;
    public NaverSpeechRecognizer(Context context, Handler handler, String clientId) {
