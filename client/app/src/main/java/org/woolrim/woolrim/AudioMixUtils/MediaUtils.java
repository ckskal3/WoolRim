...
public class MediaUtils {
    ...
    public static boolean isMatchAudioFormat(String audioFile, int sampleRate, int channelCount){
        ...
        boolean result = true;
//        Log.d("Title",audioFile+" : "+String.valueOf(mf.getInteger(MediaFormat.KEY_SAMPLE_RATE))+" , "+String.valueOf(mf.getInteger(MediaFormat.KEY_CHANNEL_COUNT)));
...
//            Log.d("Title",audioFile+" "+String.valueOf(mf.getInteger(MediaFormat.KEY_CHANNEL_COUNT)));
