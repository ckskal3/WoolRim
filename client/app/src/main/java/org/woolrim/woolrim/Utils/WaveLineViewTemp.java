...
public class WaveLineViewTemp extends RenderViewTemp {

    private final int DEFAULT_SAMPLING_SIZE = 128;
    ...
    public WaveLineViewTemp(Context context) {
        this(context, null);
    }

    public WaveLineViewTemp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveLineViewTemp(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttr(attrs);
    }

    private void initAttr(AttributeSet attrs) {
        TypedArray t = getContext().obtainStyledAttributes(attrs, jaygoo.widget.wlv.R.styleable.WaveLineView);
        backGroundColor = t.getColor(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvBackgroundColor, Color.WHITE);
        samplingSize = t.getInt(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvSamplingSize, DEFAULT_SAMPLING_SIZE);
        lineColor = t.getColor(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvLineColor, Color.parseColor("#2ED184"));
        thickLineWidth = (int)t.getDimension(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvThickLineWidth, 6);
        fineLineWidth = (int)t.getDimension(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvFineLineWidth, 2);
        offsetSpeed = t.getFloat(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvMoveSpeed, DEFAULT_OFFSET_SPEED);
        sensibility = t.getInt(jaygoo.widget.wlv.R.styleable.WaveLineView_wlvSensibility, DEFAULT_SENSIBILITY);
...
//                    Log.d("Time", "Thank");
    ...
    private boolean lineAnim(Canvas canvas) {
        if (isPrepareLineAnimEnd )return true;
        //|| !isOpenPrepareAnim
        Log.d("Time","Here");
...
//        }
    ...
    private void initDraw(Canvas canvas) {
        ...
        Log.d("Time",String.valueOf(height)+" "+String.valueOf(centerHeight));
        //振幅为高度的1/4
