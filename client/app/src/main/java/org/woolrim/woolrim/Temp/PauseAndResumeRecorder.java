...
public class PauseAndResumeRecorder {
    ...
    private static final String TAG=PauseAndResumeRecorder.class.getSimpleName();
    ...
    public void pauseRecording(){
        if (currentAudioState.get()==RECORDING_STATE){
            ...
            remainingMaxTimeInMillis= maxTimeInMillis -(System.currentTimeMillis()-recordingStartTimeMillis);
        }
        else{
    ...
    public interface OnTimeCompletionListener{
         ...
         * @param pauseResumeAudioRecorder The instance of the {@link PauseAndResumeRecorder} that had the event.
         */
        void onTimeCompleted(final PauseAndResumeRecorder pauseResumeAudioRecorder);
    }
    /**
    ...
    public interface OnFileSizeReachedListener{
         ...
         * @param pauseResumeAudioRecorder The instance of the {@link PauseAndResumeRecorder} that had the event.
         */
        void onFileSizeReached(final PauseAndResumeRecorder pauseResumeAudioRecorder);
    }
    /**
    ...
    private class MaxTimeTimerTask extends TimerTask{
        ...
        public void run(){
            ...
            if (onTimeCompletionListener != null) {
                onTimeCompletionListener.onTimeCompleted(PauseAndResumeRecorder.this);
            }
        }
    }
    ...
    private class MaxSizeReachedRunnable implements Runnable{
        ...
        public void run() {
            if (onFileSizeReachedListener !=null){
                onFileSizeReachedListener.onFileSizeReached(PauseAndResumeRecorder.this);
            }
        }
    }
}
