...
public abstract class RenderViewTemp extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public RenderViewTemp(Context context) {
        this(context, null);
    }

    public RenderViewTemp(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RenderViewTemp(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class RenderThread extends Thread {
        ...
        private WeakReference<RenderViewTemp> renderView;
        private boolean running = false;
        private boolean destoryed = false;
        private boolean isPause = false;
        public RenderThread(RenderViewTemp renderView) {
            super("RenderThread");
        ...
        private RenderViewTemp getRenderView(){
